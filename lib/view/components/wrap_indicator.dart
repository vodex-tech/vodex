...
class CheckMarkStyle {
  ...
  static const defaultStyle = CheckMarkStyle(
    ...
    completed:
        CheckMarkColors(content: Colors.white, background: AppColors.primary),
  );
}
    ...
    return CustomMaterialIndicator(
      ...
      indicatorBuilder: (
        ...
        final style = _renderCompleteState
            ? CheckMarkStyle.defaultStyle.completed
            : CheckMarkStyle.defaultStyle.loading;
        return Visibility(
          visible: controller.value > 0.1,
